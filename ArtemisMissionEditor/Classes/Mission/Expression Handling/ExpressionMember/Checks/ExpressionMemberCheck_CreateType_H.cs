...
namespace ArtemisMissionEditor
{
	...
	public sealed class ExpressionMemberCheck_CreateType_H : ExpressionMemberCheck
	{
		...
		{
			eML.Add(new ExpressionMember("<type>", "type", "type"));
		}
			...
			: base()
		{
			...
			eML.Add(new ExpressionMember("<>", "podnumber", "podnumber"));
			...
			eML.Add(new ExpressionMember("number "));
			eML.Add(new ExpressionMember("<>", "fleetnumber", "fleetnumber"));
			...
			eML.Add(new ExpressionMember("<>",		"meshFileName", "meshFileName", true));
			eML.Add(new ExpressionMember("with "	));
			eML.Add(new ExpressionMember("texture "	));
			eML.Add(new ExpressionMember("<>",		"textureFileName", "textureFileName", true));
			eML.Add(new ExpressionMember("having "	));
			eML.Add(new ExpressionMember("hull "	));
			eML.Add(new ExpressionMember("race "	));
			eML.Add(new ExpressionMember("<>",		"hullRace", "hullRace"));
			eML.Add(new ExpressionMember("and "		));
			eML.Add(new ExpressionMember("type "	));
			eML.Add(new ExpressionMember("<>",		"hullType", "hullType"));
			eML.Add(new ExpressionMember("having "	));
			...
			eML.Add(new ExpressionMember("<>",		"colorR", "colorRed"));
			eML.Add(new ExpressionMember("<>",		"colorG", "colorGreen"));
			eML.Add(new ExpressionMember("<>",		"colorB", "colorBlue"));
			...
			eML.Add(new ExpressionMember("<>", "count", "count"));
			____Add_Type(eML);
			...
			eML.Add(new ExpressionMember("of "));
			eML.Add(new ExpressionMember("<>",		"randomRange", "randomRange"));
			eML.Add(new ExpressionMember("with "		));
			eML.Add(new ExpressionMember("the "));
			eML.Add(new ExpressionMember("random "	));
			eML.Add(new ExpressionMember("seed "	));
			eML.Add(new ExpressionMember("of "));
			eML.Add(new ExpressionMember("<>",		"randomSeed", "randomSeed"));
