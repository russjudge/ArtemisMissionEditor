...
namespace ArtemisMissionEditor
{
	...
	public sealed class ExpressionMemberCheck_Point_x_Name_x_GMPos : ExpressionMemberCheck
	{
			...
			: base("", "check_p/n/gmpos")
		{
			...
			eML.Add(new ExpressionMember("<>", "x" + suffix, "centerX"));
			eML.Add(new ExpressionMember("<>", "y" + suffix, "centerY"));
			eML.Add(new ExpressionMember("<>", "z" + suffix, "centerZ"));
			
			eML = this.Add("GM position"); //_choices[1]
			//In case this is using GM pos, it looks like: "... at GM position"
			eML.Add(new ExpressionMember("", "use_gm", "use_gm_position"));
