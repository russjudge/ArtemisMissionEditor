...
namespace ArtemisMissionEditor
{
	...
	/// </summary>
	public sealed class ExpressionMemberCheck_PropertyAdd_H : ExpressionMemberCheck
	{
		...
		protected override void SetValueInternal(ExpressionMemberContainer container, string value)
		{
			...
			if (Mission.Current.Loading && value == "<READ_ONLY>")
				Log.Add("Warning! Attempt to add to read-only property " + container.GetAttribute("property") + " detected in event: " + container.ParentStatement.Parent.Name + "!");
		...
		public ExpressionMemberCheck_PropertyAdd_H()
			: base()
		{
