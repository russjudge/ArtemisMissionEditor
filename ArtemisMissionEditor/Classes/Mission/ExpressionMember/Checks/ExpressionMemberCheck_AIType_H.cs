...
namespace ArtemisMissionEditor
{
	...
	public sealed class ExpressionMemberCheck_AIType_H : ExpressionMemberCheck
	{
		...
		private void ____Add_Type(List<ExpressionMember> eML)
		{
			...
			eML.Add(new ExpressionMember("<type>", EMVD.GetItem("type_ai"), "type"));
		}
			...
			: base()
		{
			...
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("value_r"), "value1"));
			____Add_Name(eML);
			...
			eML.Add(new ExpressionMember("closer "));
			eML.Add(new ExpressionMember("than "));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("value_r|q"), "value1"));
			eML.Add(new ExpressionMember("\" "));
			____Add_Name(eML);
			...
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("angle"), "value1"));
			...
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("value_t"), "value2"));
			eML.Add(new ExpressionMember("\" "));
			____Add_Name(eML);
			...
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("x"), "value1"));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("y"), "value2"));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("z"), "value3"));
			eML.Add(new ExpressionMember("moving "));
			eML.Add(new ExpressionMember("at "));
			eML.Add(new ExpressionMember("throttle "));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("value_t"), "value4"));
			eML.Add(new ExpressionMember("\" "));
			____Add_Name(eML);
			...
			eML.Add(new ExpressionMember("at "));
			eML.Add(new ExpressionMember("throttle "));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("value_t"), "value1"));
			eML.Add(new ExpressionMember("\" ")); 
			____Add_Name(eML);
			...
			eML.Add(new ExpressionMember("closer "));
			eML.Add(new ExpressionMember("than "));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("value_r"), "value2"));
			eML.Add(new ExpressionMember(", "));
