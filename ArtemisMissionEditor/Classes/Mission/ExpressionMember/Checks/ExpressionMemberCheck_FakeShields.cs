...
namespace ArtemisMissionEditor
{
	...
	public sealed class ExpressionMemberCheck_FakeShields : ExpressionMemberCheck
	{
		...
		public ExpressionMemberCheck_FakeShields()
			: base("", EMVD.GetItem("check_fakeShields"))
		{
			...
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("fakeShieldsFR"), "fakeShieldsFront"));
			eML.Add(new ExpressionMember("with "));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("hasFakeShldFreq"), "hasFakeShldFreq"));

			eML = this.Add("fake rear shields"); //_choices[2]
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("fakeShieldsFR"), "fakeShieldsRear"));
			eML.Add(new ExpressionMember("with "));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("hasFakeShldFreq"), "hasFakeShldFreq"));

			eML = this.Add("fake front/rear shields"); //_choices[3]
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("fakeShieldsF"), "fakeShieldsFront"));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("fakeShieldsR"), "fakeShieldsRear"));
			eML.Add(new ExpressionMember("with "));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("hasFakeShldFreq"), "hasFakeShldFreq"));
		}
	}
