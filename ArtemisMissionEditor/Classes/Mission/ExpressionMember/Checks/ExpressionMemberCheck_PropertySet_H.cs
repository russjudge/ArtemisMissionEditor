...
namespace ArtemisMissionEditor
{
	...
	public sealed class ExpressionMemberCheck_PropertySet_H : ExpressionMemberCheck
	{
			...
			: base()
		{
            ...
            eML.Add(new ExpressionMember("<>", EMVD.GetItem("int-+inf"), "value"));
            ____Add_Name(eML);
            ...
            ____Add_Property(eML);
            eML.Add(new ExpressionMember("to "));
            eML.Add(new ExpressionMember("<>", EMVD.GetItem("flt-+inf"), "value"));
            ____Add_Name(eML);
			...
			____Add_Property(eML);
			eML.Add(new ExpressionMember("to "));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("int0...+inf"), "value"));
			____Add_Name(eML);
            ...
            ____Add_Property(eML);
            eML.Add(new ExpressionMember("to "));
            eML.Add(new ExpressionMember("<>", EMVD.GetItem("flt0...+inf"), "value"));
            ____Add_Name(eML);
            ...
            ____Add_Property(eML);
            eML.Add(new ExpressionMember("to "));
            eML.Add(new ExpressionMember("<>", EMVD.GetItem("int0...100"), "value"));
            ____Add_Name(eML);
            ...
            ____Add_Property(eML);
            eML.Add(new ExpressionMember("to "));
            eML.Add(new ExpressionMember("<>", EMVD.GetItem("int0...4"), "value"));
            ____Add_Name(eML);
            ...
            ____Add_Property(eML);
            eML.Add(new ExpressionMember("to "));
            eML.Add(new ExpressionMember("<>", EMVD.GetItem("flt0...100k"), "value"));
            ____Add_Name(eML);
            ...
            ____Add_Property(eML);
            eML.Add(new ExpressionMember("to "));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("flt-100k...100k"), "value"));
            ____Add_Name(eML);
            ...
            ____Add_Property(eML);
            eML.Add(new ExpressionMember("to "));
            eML.Add(new ExpressionMember("<>", EMVD.GetItem("boolyesno"), "value"));
            ____Add_Name(eML);
            ...
            ____Add_Property(eML);
            eML.Add(new ExpressionMember("to "));
            eML.Add(new ExpressionMember("<>", EMVD.GetItem("eliteaitype"), "value"));
            ____Add_Name(eML);
            ...
            ____Add_Property(eML);
            eML.Add(new ExpressionMember("to "));
            eML.Add(new ExpressionMember("<>", EMVD.GetItem("eliteabilitybits"), "value"));
            ____Add_Name(eML);
