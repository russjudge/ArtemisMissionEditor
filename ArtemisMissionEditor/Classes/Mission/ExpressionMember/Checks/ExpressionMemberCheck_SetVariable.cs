...
namespace ArtemisMissionEditor
{
	...
	public sealed class ExpressionMemberCheck_SetVariable : ExpressionMemberCheck
	{
		...
		public ExpressionMemberCheck_SetVariable()
			: base("", EMVD.GetItem("check_setvar"))
		{
			List<ExpressionMember> eML;

			eML = this.Add("<to>"); //_choices[0]
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("value"), "value")); 
			...
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("randInt"), "randomIntLow"));
			eML.Add(new ExpressionMember("... "));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("randInt"), "randomIntHigh")); 

			eML = this.Add("to a random float"); //_choices[2]
			eML.Add(new ExpressionMember("within "));
			eML.Add(new ExpressionMember("the ")); 
			eML.Add(new ExpressionMember("range "));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("randFloat"), "randomFloatLow"));
			eML.Add(new ExpressionMember("... "));
			eML.Add(new ExpressionMember("<>", EMVD.GetItem("randFloat"), "randomFloatHigh")); 
