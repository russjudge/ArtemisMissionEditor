...
namespace ArtemisMissionEditor.Expressions
{
    ...
    public static class ExpressionMemberValueEditors
    {
        ...
        public static ExpressionMemberValueEditor IsVarInteger;
        ...
        static ExpressionMemberValueEditors()
		{
           ...
           // XmlNameActionCheck.AddToDictionary("set_difficulty_level", "Set difficulty");
            ...
            XmlNameActionCheck.NewMenuGroup("Comms");
            ...
            XmlNameActionCheck.AddToDictionary("set_player_carried_type", "Fighter Bay");
           ...
           // PropertyObject.AddToDictionary("setShipSide", "Set Ship Side");
            ...
            IsVarInteger = new ExpressionMemberValueEditor();
            IsVarInteger.AddToDictionary("yes", "Integer");
            IsVarInteger.AddToDictionary("", "Float");
            IsVarInteger.PrepareContextMenuStripMethod = ExpressionMemberValueEditor.PrepareContextMenuStrip_DefaultListWithFirstSeparated;
