...
namespace ArtemisMissionEditor.SpaceMap
{
    ...
    public struct Coordinates3D
    {
        ...
        public double X
        {
            ...
            set
            {
                if (!_allow_out_of_range && value < Space.MinX)
                    value = Space.MinX;
                if (!_allow_out_of_range && value > Space.MaxX)
                    value = Space.MaxX;
                _x = value;
            }
        }
        ...
        public double Y
        {
            ...
            set
            {
                if (!_allow_out_of_range && value < Space.MinY)
                    value = Space.MinY;
                if (!_allow_out_of_range && value > Space.MaxY)
                    value = Space.MaxY;
                _y = value;
            }
        }
        ...
        public double Z
        {
            ...
            set
            {
                if (!_allow_out_of_range && value < Space.MinZ)
                    value = Space.MinZ;
                if (!_allow_out_of_range && value > Space.MaxZ)
                    value = Space.MaxZ;
                _z = value;
            }
        }
        ...
        public double X_Scr
        {
            get { return Space.MaxX - _x; }
            set { X = Space.MaxX - value; }
        }
		...
		{ this._x = (useScreenCoords ? Space.MaxX - x : x); this._y = y; this._z = z; this._allow_out_of_range = false; Validate(); }
    ...
    public struct Coordinates3DUnbound
    {
        ...
        { this._x = (useScreenCoords ? Space.MaxX - x : x); this._y = y; this._z = z; }
